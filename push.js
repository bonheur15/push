var push,testpu = require('web-push');
let vapidKeys = {
...
testpu.setVapidDetails('mailto:test@code.co.uk', vapidKeys.publicKey, vapidKeys.privateKey)
...
testpu.sendNotification(sub, 'test message')